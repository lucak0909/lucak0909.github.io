...
## Sources:
- Ultralytics Machine Learning: docs.ultralytics.com/
- PoseModule.py: Edited version of [CVzone's "PoseModule.py"](https://github.com/cvzone/cvzone/blob/master/cvzone/PoseModule.py)
- PyFirmata Documentation: pyfirmata.readthedocs.io/en/latest/
- Optimal Shooting Angles: www.researchgate.net/publication/357307984_Key_Kinematic_Components_for_Optimal_Basketball_Free_Throw_Shooting_Performance
- Finding Pose Estimation Angles: www.youtube.com/watch?v=5kaX3ta398w
- Drawing Angle Arcs: answers.opencv.org/question/173257/drawing-an-arc/
